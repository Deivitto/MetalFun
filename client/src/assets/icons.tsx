...
export const CrownIcon = ({ className = "", ...props }: { className?: string; [key: string]: any }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const ExchangeIcon = ({ className = "", ...props }: { className?: string; [key: string]: any }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const AnkIcon = ({ className = "" }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
    ...
    className={className}
  >
    <path d="M12 3v12m-4 4h8m-4-8a8 8 0 006-3" />
  </svg>
);
...
export const CatIcon = ({ className = "" }: { className?: string }) => (
  <svg
    ...
    className={className}
  >
    <path d="M12 5c.67 0 1.35.09 2 .26 1.78-2 5.03-2.84 6.42-2.26 1.4.58-.42 7-.42 7 .57 1.07 1 2.24 1 3.44C21 17.9 16.97 21 12 21s-9-3-9-7.56c0-1.25.5-2.4 1-3.44 0 0-1.89-6.42-.5-7 1.39-.58 4.72.31 6.5 2.26A8.63 8.63 0 0112 5z" />
...
export const CoinStackIcon = ({ className = "" }: { className?: string }) => (
  ...
  >
    ...
    <path d="M6 11.05a7 7 0 0012 0" />
    <circle cx="12" cy="14" r="5" />
    <path d="M6 19.05a7 7 0 0012 0" />
  </svg>
);
